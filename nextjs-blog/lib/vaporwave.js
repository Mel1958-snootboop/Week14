...
const vaporwaveURL = "https://dev-srjc-fall-2025.pantheonsite.io/wp-json/wp/v2/vaporwave/";
...
export async function getAllIds() {
  ...
  // const filePath = path.join(dataDir, 'data.json');
    ...
    try {
      ...
      jsonString = await got(vaporwaveURL);
...
export async function getVaporwave(idRequested) {
